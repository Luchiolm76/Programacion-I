...
def menu():
    ...
    while True:
        ...
        if opcion == '1':
            ...
            juegos_ordenados = bubble_sort(juegos_ordenados, key) #llamamos a la funcion de ordenamiento por burbuja
            ...
            juegos_ordenados = quick_sort(juegos_ordenados, key) #llamamos a la funcion de ordenamiento rapido y le pasamos la clave
            #mostramos los juegos ordenados
